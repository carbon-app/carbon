...
- [Carbon for Slack](https://github.com/faisalsayed10/carbon-slack) - Create beautiful images of your code directly from slack. Just invoke the `/carbon` command and fill out the details!
