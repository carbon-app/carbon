  ...
  <style jsx global>
    {`
      ...
      @font-face {
        ...
        font-style: normal;
        font-weight: 400;
        src: local('Victor Mono'), local('VictorMono-Regular'),
          url(https://unpkg.com/victormono/dist/woff2/VictorMono-Regular.woff2)
            format('woff2');
      }
      ...
      @font-face {
        ...
        font-style: italic;
        font-weight: 400;
        src: local('Victor Mono Italic'), local('VictorMono-Italic'),
          url(https://unpkg.com/victormono/dist/woff2/VictorMono-Italic.woff2)
            format('woff2');
      }
`}
  </style>
