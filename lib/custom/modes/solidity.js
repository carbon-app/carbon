...
// Solidity mode by alincode on github
...
CodeMirror.defineMode('solidity', function (config) {
  ...
  function tokenBase(stream, state) {
    ...
    if (
      Object.prototype.propertyIsEnumerable.call(keywordsControlStructures, cur) ||
      Object.prototype.propertyIsEnumerable.call(keywordsTypeInformation, cur) ||
      Object.prototype.propertyIsEnumerable.call(keywordsV0505NewReserve)
    )
      return 'keyword'
    if (
    ...
    if (
      Object.prototype.propertyIsEnumerable.call(keywordsMathematicalAndCryptographicFuctions, cur)
    )
      return 'mathematicalAndCryptographic'

    if (
      Object.prototype.propertyIsEnumerable.call(keywordsMoreBlockAndTransactionProperties, cur) ||
      (Object.prototype.hasOwnProperty.call(keywordsBlockAndTransactionProperties, cur) &&
    ...
    if (
      Object.prototype.hasOwnProperty.call(keywordsAbiEncodeDecodeFunctions, cur) &&
